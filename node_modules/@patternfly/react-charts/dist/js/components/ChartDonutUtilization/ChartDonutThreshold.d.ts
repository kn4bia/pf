...
import { AnimatePropTypeInterface, CategoryPropType, ColorScalePropType, DataGetterPropType, EventPropTypeInterface, PaddingProps, StringOrNumberOrCallback, VictoryStyleInterface } from "victory";
...
export declare enum ChartDonutThresholdLegendPosition {
    bottom = "bottom",
    right = "right"
}
