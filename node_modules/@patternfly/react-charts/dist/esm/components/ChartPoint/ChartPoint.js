...
ChartPoint.propTypes = {
  ...
  style: _pt.any,
  symbol: _pt.oneOfType([_pt.oneOf(['circle']), _pt.oneOf(['diamond']), _pt.oneOf(['plus']), _pt.oneOf(['minus']), _pt.oneOf(['square']), _pt.oneOf(['star']), _pt.oneOf(['triangleDown']), _pt.oneOf(['triangleUp']), _pt.oneOf(['dash']), _pt.any]),
