...
import { ChartAxisTheme, ChartBaseTheme, ChartDonutTheme, ChartDonutUtilizationDynamicTheme, ChartDonutUtilizationStaticTheme, ChartDonutThresholdDynamicTheme, ChartDonutThresholdStaticTheme, ChartThemeColor, ChartThemeVariant } from '../ChartTheme/ChartTheme';
import { cloneDeep } from 'lodash'; // Apply custom properties to color and base themes

export const getCustomTheme = (themeColor, themeVariant, customTheme) => merge(getTheme(themeColor, themeVariant), customTheme); // Apply axis threshold properties onto base theme
...
export const getDonutTheme = (themeColor, themeVariant) => getCustomTheme(themeColor, themeVariant, ChartDonutTheme); // Apply dynamic donut threshold properties onto pie chart theme
