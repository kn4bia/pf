(function (global, factory) {
  ...
  const ChartDonutUtilization = exports.ChartDonutUtilization = _ref => {
    ...
    const chart = React.createElement(React.Fragment, null, React.createElement(_ChartDonut.ChartDonut, _extends({
  ...
  ChartDonutUtilization.propTypes = {
    ...
    donutDx: _propTypes2.default.number,
    donutDy: _propTypes2.default.number,
