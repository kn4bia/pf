(function (global, factory) {
  ...
  const TYPOGRAPHY_FONT_SIZE = _reactTokens.chart_global_FontSize_sm.value; // Labels
  ...
  const STROKE_LINE_CAP = _reactTokens.chart_global_stroke_line_cap.value;
  const STROKE_LINE_JOIN = _reactTokens.chart_global_stroke_line_join.value; // Victory theme properties only
